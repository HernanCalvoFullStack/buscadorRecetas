function iniciarApp() {
  ...
  function mostrarRecetas(recetas = []) {
    ...
    heading.textContent = recetas.length ? "Resutlados" : "No hay resultados";
  ...
  function mostrarRecetaModal(receta) {
    ...
    const modadTitle = document.querySelector(".modal .modal-title");
    const modalBody = document.querySelector(".modal .modal-body");

    modadTitle.textContent = strMeal;
    modalBody.innerHTML = `
    ...
    botonCerrar.classList.add("btn", "btn-secondary", "col");
  ...
  function obtenerFavoritos() {
    ...
    noFavoritos.classList.add("fs-4", "text-cemter", "font-bold", "mt-5");
